...
pub use extraction_metrics::{
    ...
    record_quality_score, record_rule_mismatch_failure, record_success, record_validation_failure,
    reset_source, restore_from_snapshot, snapshot, snapshot_persisted, stats_for, summary,
    ExtractionSummary, SourceExtractionStats,
};
pub use legado::{selector, LegadoEngine};
