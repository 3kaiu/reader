...
fn package_search_rank(package: &SourceRulePackage) -> i64 {
...
fn sort_packages_for_search(packages: &mut [SourceRulePackage]) {
        ...
        for strategy in external_discovery_strategies(package) {
            ...
            for hit in hits {
                ...
                items.push(BookItem {
                    ...
                    search_explain: Some(build_search_explain(
                        SearchExplainStrategy::ExternalDiscovery,
...
async fn direct_detail_results(
    ...
    for package in packages {
        ...
        items.push(BookItem {
            ...
            search_explain: Some(build_search_explain(
                SearchExplainStrategy::DirectDetail,
                "book_info",
                Some("matched direct detail URL".to_string()),
            )),
        });
    }
