//! Cryptographic Provider - AES, DES, 3DES encryption/decryption
//!
...
impl CryptoProvider {
    ...
    pub fn aes_decode_bytes(
        ...
        use aes::Aes128;
        use cbc::cipher::{BlockDecryptMut, KeyIvInit, block_padding::Pkcs7, block_padding::NoPadding};
    ...
    pub fn aes_encode_bytes(
        ...
        match mode.to_uppercase().as_str() {
            "CBC" | "" => {
                ...
                cipher.encrypt_padded_mut::<Pkcs7>(&mut buf, data.len())
                    .map(|e| e.to_vec())
...
mod tests {
    ...
    fn test_aes_args_base64() {
        ...
        let encrypted = CryptoProvider::aes_encode_args_base64(
            data, &key_b64, "CBC", "PKCS7", &iv_b64
        ).unwrap();
        
        let decrypted = CryptoProvider::aes_decode_args_base64(
    ...
    fn test_triple_des_args_base64() {
        ...
        let encrypted = CryptoProvider::triple_des_encode_args_base64(
            data, &key_b64, "CBC", "PKCS7", &iv_b64
        ).unwrap();
