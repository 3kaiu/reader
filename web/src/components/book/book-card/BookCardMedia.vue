...
<template>
  ...
  >
    <div
      class="px-4 py-2 bg-primary text-primary-foreground rounded-full flex items-center justify-center gap-2 shadow-xl shadow-primary/30 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out"
    >
