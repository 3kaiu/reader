...
import type { ReaderScrollLoadStateVisibilityBindings } from './reader-scroll-load-state-binding-types'
...
export function createReaderScrollLoadStateVisibilityBindings(
  ...
  const showInitialParsing = computed(() => props.isParsing && !props.hasLoadedChapters)
