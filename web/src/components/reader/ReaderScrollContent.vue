...
import type { ReaderScrollContentEmits } from './reader-scroll-content-emit-types'
...
const { contentContainerStyle, chapterListProps, loadStateProps } =
  createReaderScrollContentBindings(props)
</script>

<template>
  <div class="mx-auto px-6 pb-40 pt-20" :style="contentContainerStyle">
