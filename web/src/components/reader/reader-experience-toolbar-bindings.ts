...
import { createReaderExperienceToolbarPropsBindings } from './reader-experience-toolbar-props-bindings'
...
export function createReaderExperienceToolbarBindings(
  ...
  return computed(() =>
    createReaderExperienceToolbarPropsBindings(toolbarProps.value, actions, handleToggleEyeCare)
  )
}
