...
<template>
  <Transition name="slide-up">
    <div
      v-if="isVisible"
      class="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] w-[90vw] max-w-md"
    >
      <div
        class="bg-card/95 backdrop-blur-xl border border-primary/20 rounded-3xl shadow-2xl overflow-hidden p-6 ring-1 ring-black/5"
      >
        <!-- 头部 -->
        ...
        <div class="relative min-h-[100px]">
          ...
          >
            ...
            <span
              v-if="isLoading && recapText"
              class="inline-block w-1 h-4 bg-primary animate-pulse ml-0.5"
            />
          </div>
        </div>
