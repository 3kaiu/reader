...
} from '@/composables/reader/experience-binding-result-types'
import { createReaderExperienceAssistBindings } from './reader-experience-assist-bindings'
...
export function createReaderExperienceSectionBindings(
  ...
  return {
    ...
    modalBindings: createReaderExperienceModalBindings(
      props.actions,
      bindings.modalProps,
    ),
    assistBindings: createReaderExperienceAssistBindings(
      bindings.assistState,
      bindings.assistActions,
    ),
  }
}
