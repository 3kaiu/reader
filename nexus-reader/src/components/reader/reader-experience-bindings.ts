...
import {
  createReaderExperienceLayoutBindings,
} from './reader-experience-layout-bindings'
import type {
  ReaderExperienceLayoutProps,
} from './reader-experience-layout-prop-types'
import {
  createReaderExperienceSectionBindings,
} from './reader-experience-section-bindings'
...
export function createReaderExperienceComponentBindings(
  ...
  const layoutProps: ReaderExperienceLayoutProps =
    createReaderExperienceLayoutBindings({
      ...sectionBindings,
