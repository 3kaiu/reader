...
<template>
  <div class="min-h-screen bg-background selection:bg-primary/20 pb-20">
    ...
    <main class="max-w-7xl mx-auto px-4 pt-6 space-y-10">
        ...
        <div class="space-y-12">
          ...
          <div class="flex gap-4 overflow-hidden">
            <Skeleton
              width="85vw"
              height="48vw"
              class-name="rounded-3xl shrink-0 sm:w-[60vw]"
              v-for="i in 2"
              :key="i"
            />
          </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                  <h2
                    class="text-xl sm:text-2xl font-bold text-white mb-1 line-clamp-1"
                  >
                    {{ book.name }}
                  </h2>
                  <p
            ...
            >
              ...
              <div class="flex-1 min-w-0 space-y-1.5">
                <div class="flex items-center gap-2">
                  ...
                  >
                  <h4
                    class="font-bold text-base truncate group-hover:text-primary transition-colors"
                  >
                    {{ book.name || "未知书名" }}
                  </h4>
                </div>
      ...
      <div
        v-else
        class="flex flex-col items-center justify-center py-32 space-y-4 opacity-50"
      >
